...
if(isset($_POST['submit']))
{
	...
	if($fileerror == 0){
		...
		$insertquery = "insert into booking(dogname, breedname, age, gender, firstname, lastname, email, number, left_view, right_view, pay_slip) values('$dogname', '$breedname', '$age', '$gender', '$firstname', '$lastname', '$email', '$number', '$destfile', '$destfile2', '$destfile3')";
